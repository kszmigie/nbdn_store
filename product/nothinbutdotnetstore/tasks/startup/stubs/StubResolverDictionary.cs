            ...
            resolvers = new Dictionary<Type, object>
                {
                    ...
                    {typeof (MapperRegistry), new FunctionalDependencyResolver(() => new DefaultMapperRegistry(IOC.retrieve.an<IDictionary<Type, IDictionary<Type, object>>>()))},
                    ...
                    {typeof (IDictionary<Type, IDictionary<Type, object>>), new FunctionalDependencyResolver(() => StubSetOfMappers.set_of_mappers)}
                };
